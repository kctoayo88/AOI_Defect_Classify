...
mcp_save = ModelCheckpoint('./NASNetLarge.weight', save_best_only=True, save_weights_only=True, monitor='val_loss', mode='min')
...
net = NASNetLarge(input_shape=(img_height, img_width, 3),
                              include_top=False, 
                              weights='imagenet', 
                              pooling='max')
...
# save model as type of numpy, the web is : https://zhuanlan.zhihu.com/p/34300426
...
model.save_weights('NASNetLarge_model.weight')
